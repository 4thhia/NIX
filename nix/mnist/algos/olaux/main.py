...
from nix.mnist.algos.olaux.train import Networks, train, evaluate
...
def setup_networks(
    ...
    return Networks(state_encoder, state_decoder, state_classifier, state_weightunet)
...
def main(cfg: DictConfig) -> None:
    ...
    cfg.run_name = (
        ...
        f"__kld_coef={cfg.kld_coef}__activation={cfg.weight.activation}__regularization_type={cfg.weight.regularization_type}__regularization_coef={cfg.weight.regularization_coef}"
        f"__lr_weightunet={cfg.optimizers.weightunet.lr}__intensity={cfg.dataset.intensity}__zdim={cfg.training.zdim}"
    )
