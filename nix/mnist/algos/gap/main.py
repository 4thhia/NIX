...
from nix.mnist.algos.gap.train import Networks, train, evaluate
...
def main(cfg: DictConfig) -> None:
    ...
    cfg.run_name = (
        ...
        f"__gamma_max={cfg.algo.gamma.max}__lr_gamma_coef={cfg.algo.gamma.coef.lr}__gamma_coef_bound={cfg.algo.gamma.coef.bound}"
    ...
    networks = setup_networks(
        ...
        gamma_coef=cfg.algo.gamma.coef.initial_value,
    )
